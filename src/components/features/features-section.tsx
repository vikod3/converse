    ...
    <section className="relative min-h-screen bg-background py-16 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          <FeatureCard
            span2={true}
            title="Seamless AI Management. Anywhere, Anytime."
            description="Get full control over your AI agents with our powerful cloud dashboard. Monitor performance, deploy updates, and refine workflows, all in real-time, from any browser."
            buttonText="Get started Now"
            icon={<Bot size={24} />}
            image="/lovable-uploads/b8716932-c9b4-4e3c-9c71-39e7215a804b.png"
          />
          
          <FeatureCard
            title="Tailor-Made Conversations. Just for You."
            description="Craft unique responses and behaviors for your chatbot using our flexible logic editor. Match your brand's tone, style, and intelligence to create the perfect conversational experience."
